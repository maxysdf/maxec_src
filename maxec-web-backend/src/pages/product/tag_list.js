...
export default function TagListPage() {
    ...
    useEffect(() => {
        const qry = `query ($param:ProductTagPageParam) {
            pageTag(param: $param) { ${GQL_RESP}
              page { ${GQL_PAGE_FLDS}
                result:pageTagResult { 
                    id type name code sort value
                }
              }
            }
        }`;
            ...
            <div className="col-12">
                <div className="card">
                    <div className="card-header">
                        <h3 className="card-title">標籤清單</h3>
    ...
    return (<LayoutAdmin components={comp} title="標籤管理"></LayoutAdmin>);
}