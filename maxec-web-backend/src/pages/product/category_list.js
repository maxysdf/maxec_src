...
export default function CategoryListPage() {
    ...
    useEffect(() => {
        const qry = `query ($param:ProductCategoryPageParam) {
            pageCategory(param: $param) { ${GQL_RESP}
              page { ${GQL_PAGE_FLDS}
                result:pageCategoryResult { 
                    id name
                }
              }
            }
        ...
        utGQL(qry, {param:{pageSize:10,pageNo:pageNo,keywords:keywords}}, (data) => {
            setLoading(false);
            setPage(data.pageCategory.page);
        });
            ...
            <div className="col-12">
                <div className="card">
                    <div className="card-header">
                        <h3 className="card-title">分類清單</h3>
    ...
    return (<LayoutAdmin components={comp} title="分類管理"></LayoutAdmin>);
}